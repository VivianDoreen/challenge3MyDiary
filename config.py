...
class MainConfiguration(object):
    ...
    DEBUG = False
    CSRF_ENABLED = True #Cross-Site Request Forgery (CSRF) is an attack that forces an end user to execute unwanted actions on a web application in which they're currently authenticated
